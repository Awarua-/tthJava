...
/**
 * tth.Base32 - encodes and decodes 'Canonical' tth.Base32
 * (see 
...
public class Base32 {
    ...
    /** For testing, take a command-line argument in tth.Base32, decode, print in hex,
     * encode, print
     */
    static public void main(String[] args) {
        if (args.length==0) {
            System.out.println("Supply a tth.Base32-encoded argument.");
            return;
        }
